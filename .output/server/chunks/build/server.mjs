...
import { defineComponent, shallowRef, h, resolveComponent, useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString as toDisplayString$1, createVNode, toRef, toValue, resolveDynamicComponent, watch, useAttrs, useTemplateRef, isRef, hasInjectionContext, provide, mergeModels, useModel, createTextVNode, onServerPrefetch, getCurrentInstance as getCurrentInstance$1, nextTick, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, shallowReactive, Suspense, Fragment, createApp, Text, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, t as parseQuery, v as defu, w as klona, x as defuFn, y as hasProtocol, z as joinURL, A as isEqual, B as withQuery, C as withTrailingSlash, D as withoutTrailingSlash, E as isScriptProtocol, F as sanitizeStatusCode, G as getContext, H as withLeadingSlash, I as parseURL, m as createError$1, $ as $fetch$1, J as baseURL, K as createHooks, L as executeAsync, M as toRouteMatcher, N as createRouter$1, O as getRequestURL, P as getCookie, Q as getRequestHeader, o as destr, R as createDefu, S as parse$1, T as parsePath, U as setCookie, V as deleteCookie, W as encodeParam, X as encodePath } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-D_xo841v.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./index-Bh0qnopb.mjs')
  },
  {
    name: "dsvgo",
    path: "/dsvgo",
    component: () => import('./index-Dr04gpp2.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./index-BRyB-k9I.mjs')
  },
  {
    name: "support",
    path: "/support",
    component: () => import('./index-BoUnvO3Z.mjs')
  },
  {
    name: "calendar",
    path: "/calendar",
    component: () => import('./index-DSN1vIaf.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-CdKPG2-z.mjs')
  }
];
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-B7W3-zJk.mjs'
    /* webpackChunkName: "config_i18n_46config_46ts_490c5054" */
  )
];
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/ByP77O0Q"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/ByP77O0Q"}/${locale}/messages.json`));
...
const ipxRuntime$UI55KMgpmP1MSVnE9Y0OuiVry2UKWWj_ZHTJz0wYKZU = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$UI55KMgpmP1MSVnE9Y0OuiVry2UKWWj_ZHTJz0wYKZU, defaults: {} }
  }
};
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D-X3V-he.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CKNoQ-KC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CS25ds7v.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, __nuxt_component_1$1 as b, _sfc_main$8 as c, useLocale as d, entry_default as default, useAppConfig as e, _sfc_main$9 as f, useFieldGroup as g, useComponentIcons as h, _sfc_main$e as i, _sfc_main$b as j, usePortal as k, isArrayOfArray as l, get as m, _sfc_main$a as n, useI18n as o, pickLinkProps as p, __nuxt_component_3 as q, useToast as r, tv as t, useHead as u };
